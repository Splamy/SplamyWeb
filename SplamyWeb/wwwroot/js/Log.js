var Log = (function (exports) {
    ...
    /* node_modules\svelte-tiny-virtual-list\src\VirtualList.svelte generated by Svelte v3.40.2 */
    		...
    		p(new_ctx, dirty) {
    			...
    			if (item_slot) {
    				if (item_slot.p && (!current || dirty[0] & /*$$scope, items*/ 262146)) {
    					update_slot(item_slot, item_slot_template, ctx, /*$$scope*/ ctx[18], !current ? [-1, -1] : dirty, get_item_slot_changes, get_item_slot_context);
    				}
    			}
    		},
    		i(local) {
    		...
    		p(ctx, dirty) {
    			if (header_slot) {
    				if (header_slot.p && (!current || dirty[0] & /*$$scope*/ 262144)) {
    					update_slot(header_slot, header_slot_template, ctx, /*$$scope*/ ctx[18], !current ? [-1, -1] : dirty, get_header_slot_changes, get_header_slot_context);
    				}
    			}
    			...
    			if (footer_slot) {
    				if (footer_slot.p && (!current || dirty[0] & /*$$scope*/ 262144)) {
    					update_slot(footer_slot, footer_slot_template, ctx, /*$$scope*/ ctx[18], !current ? [-1, -1] : dirty, get_footer_slot_changes, get_footer_slot_context);
    				}
    			}
    ...
    /* Svelte\SvPage.svelte generated by Svelte v3.40.2 */

    function create_item_slot(ctx) {
    	let div;
    	let t0_value = /*events*/ ctx[1][/*maxId*/ ctx[0] - /*index*/ ctx[13]]?.loggerName + "";
    	let t0;
    	let t1;
    	let t2_value = /*events*/ ctx[1][/*maxId*/ ctx[0] - /*index*/ ctx[13]]?.formattedMessage + "";
    	let t2;
    	let div_style_value;
    	...
    	return {
    		c() {
    			...
    			t2 = text(t2_value);
    			attr(div, "slot", "item");
    			attr(div, "style", div_style_value = /*style*/ ctx[12]);
    			attr(div, "class", "row");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*events, maxId, index*/ 8195 && t0_value !== (t0_value = /*events*/ ctx[1][/*maxId*/ ctx[0] - /*index*/ ctx[13]]?.loggerName + "")) set_data(t0, t0_value);
    			if (dirty & /*events, maxId, index*/ 8195 && t2_value !== (t2_value = /*events*/ ctx[1][/*maxId*/ ctx[0] - /*index*/ ctx[13]]?.formattedMessage + "")) set_data(t2, t2_value);

    			if (dirty & /*style*/ 4096 && div_style_value !== (div_style_value = /*style*/ ctx[12])) {
    ...
    function create_fragment(ctx) {
    	...
    	virtuallist = new VirtualList({
    			props: {
    				height: 500,
    				width: "auto",
    				itemCount: /*itemCount*/ ctx[2],
    				itemSize: 50,
    				$$slots: {
    					item: [
    						create_item_slot,
    						({ style, index }) => ({ 12: style, 13: index }),
    						({ style, index }) => (style ? 4096 : 0) | (index ? 8192 : 0)
    					]
    				},
    				$$scope: { ctx }
    			}
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*itemCount*/ 4) virtuallist_changes.itemCount = /*itemCount*/ ctx[2];

    			if (dirty & /*$$scope, style, events, maxId, index*/ 28675) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const connection = new HubConnectionBuilder().withUrl("/livelog").build();
    	let events = {};
    	let maxId = null;
    	let minId = null;
    	...
    	connection.on("LogRange", function (evs) {
    		addRange(evs);
    	});
    	...
    	function getTop() {
    		return __awaiter(this, void 0, void 0, function* () {
    			addRange(yield connection.invoke("GetTop"));
    		});
    	}

    	function addRange(evs) {
    		for (const ev of evs) {
    			addEvent(ev);
    		}
    	}
    	...
    	function addEvent(ev) {
    		$$invalidate(0, maxId = maxId === null
    		? ev.sequenceID
    		: Math.max(ev.sequenceID, maxId));

    		$$invalidate(3, minId = minId === null
    		? ev.sequenceID
    		: Math.min(ev.sequenceID, minId));

    		$$invalidate(1, events[ev.sequenceID] = ev, events);
    	}

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*maxId, minId*/ 9) {
    			$$invalidate(2, itemCount = maxId - minId);
    		}
    	};

    	return [maxId, events, itemCount, minId];
    }

    class SvPage extends SvelteComponent {
    	constructor(options) {
    		super();
