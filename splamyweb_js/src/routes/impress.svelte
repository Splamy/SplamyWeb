...
<article class="readblock content">
	<h2><a id="Impressum_0" />Impressum</h2>
	<p>
		Lukas Jagemann<br />
		splamyn🐈gmail⚫com<br />
		Yorckstr. 2d, 80637 München
	</p>
	<h2><a id="Datenschutzerklrung_5" />Datenschutzerklärung</h2>
	<h3><a id="Grundlegendes_7" />Grundlegendes</h3>
	<p>
	...
	<h3><a id="Zugriffsdaten_15" />Zugriffsdaten</h3>
	<p>
	...
	<p>
		Die Server-Logfiles werden für maximal drei Monate gespeichert und anschließend gelöscht.
		Die Speicherung der Daten erfolgt aus Sicherheitsgründen, um z. B. Missbrauchsfälle
		aufklären zu können. Müssen Daten aus Beweisgründen aufgehoben werden, sind sie solange von
		der Löschung ausgenommen bis der Vorfall endgültig geklärt ist.
	</p>
	<h3>
		<a id="Erfassung_und_Verarbeitung_personenbezogener_Daten_28" />Erfassung und Verarbeitung
	...
	<p>
		...
		bestimmen und welche zu Ihnen zurückverfolgt werden können – also beispielsweise Ihre
		IP-Adresse.
	</p>
	<p>
	...
	<h3><a id="Umgang_mit_Kontaktdaten_34" />Umgang mit Kontaktdaten</h3>
	<p>
	...
	<h3><a id="Rechte_des_Nutzers_38" />Rechte des Nutzers</h3>
	<p>
	...
	<h3><a id="Lschung_von_Daten_42" />Löschung von Daten</h3>
	<p>
	...
	<h3><a id="Widerspruchsrecht_46" />Widerspruchsrecht</h3>
	<p>
	...
	<p>
		...
		möchten, wenden Sie sich bitte an die oben genannte E-Mail-Adresse.
	</p>
</article>
